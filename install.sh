...
REPO_DIR="$(dirname $0)"
EXEC_FILES="git-hf"
SCRIPT_FILES="git-hf-init git-hf-feature git-hf-hotfix git-hf-push git-hf-pull git-hf-release git-hf-support git-hf-update git-hf-upgrade git-hf-version git-hf-tag git-hf-build hubflow-common hubflow-shFlags"
